...
var dateFormat = function () {
	...
	return function (date, mask, utc) {
		...
		// replaced $0 with val
		return mask.replace(token, function (val) {
			return val in flags ? flags[val] : val.slice(1, val.length - 1);
		});
	};
}();
...
Date.prototype.
/**
 * Format a Date object using mask. 
 * 
 * @param {string} mask The date format mask.
 * @param {boolean} utc Format local time as UTC  
...
/**
 * Return a UTC instance of this date object.
 * 
...
/**
 * Parses a ISO 8601 format string to a date object
 * 
 * @param {string} str date value in ISO 8601 format.
